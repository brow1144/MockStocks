...
class Home extends Component {
  ...
  stateGetData = (game) => {
    ...
    //TODO If no game, don't show graph
      ...
      axios.get(`https://portfolio-408-defect.herokuapp.com//Portfol.io/Games/History/${this.props.uid}/${game.code}`)
      .then((response) => {
        // handle success
  ...
  getData = () => {
    ...
    if (this.props.currentGame !== {} && this.props.currentGame !== null && this.props.currentGame !== undefined) {
      axios.get(`https://portfolio-408-defect.herokuapp.com//Portfol.io/Games/History/${this.props.uid}/${this.props.currentGame.code}`)
      .then((response) => {
        // handle success
        let stockData = response.data;
        this.showDataFromAPI(stockData);
  ...
  //   axios.get(`https://portfolio-408-defect.herokuapp.com//Portfol.io/Stock/MSFT/${this.state.selected}`)
  //     .then((response) => {
  //       // handle success
  //       let stockData = response.data;
  //       this.showDataFromAPI(stockData);
