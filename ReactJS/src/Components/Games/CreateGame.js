...
class CreateGame extends Component {
  ...
  joinIt = () => {
    ...
    axios.put(`https://portfolio-408-defect.herokuapp.com//Portfol.io/Games/${this.props.uid}/${gameId}`)
      .then((response) => {
  ...
  createIt = () => {
    ...
    if (self.state.startDate < self.state.endDate) {
      ...
      axios.post(`https://portfolio-408-defect.herokuapp.com//Portfol.io/Games`,
        {
          code: gameId,
